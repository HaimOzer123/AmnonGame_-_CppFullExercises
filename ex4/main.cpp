#include <iostream> 
/**
 * @brief simple vending machine program that allows the user to select a drink and then displays the remaining drink count.
 * The program should have the following drinks: soda, cola, and coffee.
 * The program should allow the user to select a drink and then display the remaining drink count.
 * The program should allow the user to refill the drinks.
 * The program should allow the user to quit the program.
 * The program should display an error message if the user selects an invalid drink.
 * 
 * @return int 
 */
